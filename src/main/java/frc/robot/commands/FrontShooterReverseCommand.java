...
public class FrontShooterReverseCommand extends CommandBase {
   ...
   */
  public FrontShooterReverseCommand(FrontShooter frontShooter) {
  ...
  @Override
  public void execute() {
    m_frontshooter.tourneSensHoraire();
  }
