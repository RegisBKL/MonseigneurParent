...
import frc.robot.Constants.FrontShooterConstants;
...
public class FrontShooter extends SubsystemBase {
  ...
  private final WPI_VictorSPX m_frontshooter_Motor = new WPI_VictorSPX(FrontShooterConstants.frontshootermotor);
  private final double m_frontshooterspeed = 0.5; 
  // Creation d'un objet Mecanisme2
  public FrontShooter() {
    m_frontshooter_Motor.configFactoryDefault();
  ...
  public void tourneSensHoraire() {
    ...
    m_frontshooter_Motor.set(ControlMode.PercentOutput, m_frontshooterspeed);
  }
  ...
  public void tourneAnySens(double speed) {
    //m_intake_Motor.set(ControlMode.PercentOutput, -Mecanisme2Constants.kvitesseRotation);
    m_frontshooter_Motor.set(ControlMode.PercentOutput, speed);
  }
  ...
  public void mettreAuRepos() {
    ...
    m_frontshooter_Motor.set(ControlMode.PercentOutput, 0);
    //m_Verin2.set(true);
